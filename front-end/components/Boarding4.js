...
export default function Borading1({navigation}) {
    return(
        <View backgroundColor="white" w="100%" h="100%" alignItems="center">
            ...
            <Image size="100%" borderRadius="10" source={require('../src/images/undraw_cooking_re_ux62.png')} alt="image" />
            </AspectRatio>
            <AspectRatio w="90%" ratio={2/1} mb="10%" >
            <Image size="100%" borderRadius="10" source={require('../src/images/undraw_eating_together_re_ux62.png')} alt="image" />
            </AspectRatio>
